...
class InventoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<InventoryItem> inStockItems =
        inventoryItems.where((item) => item.status == 'In Stock').toList();

    List<InventoryItem> lowStockItems =
        inventoryItems.where((item) => item.status == 'Low Stock').toList();

    List<InventoryItem> outOfStockItems =
        inventoryItems.where((item) => item.status == 'Out of Stock').toList();
  ...
  Widget buildInventorySection(
      BuildContext context, String sectionTitle, List<InventoryItem> items) {
    return Column(
