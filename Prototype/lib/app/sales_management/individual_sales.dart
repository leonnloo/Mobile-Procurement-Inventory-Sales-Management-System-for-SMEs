...
class IndividualSales extends StatefulWidget {
  IndividualSales({super.key});
  ...
  @override
  State<IndividualSales> createState() => _IndividualSalesState();
}

class _IndividualSalesState extends State<IndividualSales> {
                ...
                BarChartData(
                  ...
                  gridData: FlGridData(
                    ...
                    getDrawingHorizontalLine: (value) => FlLine(
                      color: const Color.fromARGB(137, 11, 6, 6).withOpacity(0.6),
                      strokeWidth: 1,
                    ),
                  ),
