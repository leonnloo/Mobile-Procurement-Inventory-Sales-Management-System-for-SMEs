...
import 'package:prototype/widgets/legend_widget';

class MonthlyPurchaseChart extends StatelessWidget {
  const MonthlyPurchaseChart({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          LegendsListWidget(
            legends: [
              Legend('Item A', pilateColor),
              Legend('Item B', cyclingColor),
              Legend('Item C', quickWorkoutColor),
            ],
          ),
